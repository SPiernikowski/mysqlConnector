...
class ClientMessages :
 ...
 public:
  ...
  inline ClientMessages* New() const final {
    return CreateMaybeMessage<ClientMessages>(nullptr);
  }

  ClientMessages* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
class ServerMessages :
 ...
 public:
  ...
  inline ServerMessages* New() const final {
    return CreateMaybeMessage<ServerMessages>(nullptr);
  }

  ServerMessages* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
class Error :
 ...
 public:
  ...
  void _internal_set_sql_state(const std::string& value);
...
inline void Error::clear_sql_state() {
  sql_state_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
inline std::string* Error::mutable_sql_state() {
  ...
  return _internal_mutable_sql_state();
}
...
inline void Error::_internal_set_sql_state(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  sql_state_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
...
inline void Error::set_sql_state(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000002u;
  sql_state_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:Mysqlx.Error.sql_state)
}
inline void Error::set_sql_state(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000002u;
  sql_state_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:Mysqlx.Error.sql_state)
}
inline std::string* Error::_internal_mutable_sql_state() {
  _has_bits_[0] |= 0x00000002u;
  return sql_state_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* Error::release_sql_state() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return sql_state_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void Error::set_allocated_sql_state(std::string* sql_state) {
  ...
  sql_state_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), sql_state);
